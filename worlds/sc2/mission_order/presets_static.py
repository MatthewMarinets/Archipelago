...
if TYPE_CHECKING:
    from .types import CampaignPresetDict, EntryRulePresetDict


preset_mini_wol_with_prophecy: 'CampaignPresetDict' = {
    "global": {
        "type": "column",
        "mission_pool": [
...
preset_mini_prophecy: 'CampaignPresetDict' = {"layouts": {"Prophecy": preset_mini_wol["layouts"].pop("Prophecy")}}
preset_mini_prophecy["layouts"]["Prophecy"].pop("entry_rules")
preset_mini_prophecy["layouts"]["Prophecy"]["type"] = "gauntlet"
preset_mini_prophecy["layouts"]["Prophecy"]["display_name"] = ""
preset_mini_prophecy["layouts"]["Prophecy"]["missions"].append({ "index": "entrances", "entry_rules": [] })

preset_mini_hots: 'CampaignPresetDict' = {
    "global": {
        "type": "column",
        "mission_pool": [
...
preset_mini_lotv_prologue: 'CampaignPresetDict' = {
    "min_difficulty": "easy",
    "layouts": {
        "Prologue": {
            "display_name": "",
...
preset_mini_lotv: 'CampaignPresetDict' = {
    "global": {
        "type": "column",
        "mission_pool": [
...
preset_mini_lotv_epilogue: 'CampaignPresetDict' = {
...
preset_mini_nco: 'CampaignPresetDict' = {
    "min_difficulty": "easy",
    "global": {
        "type": "column",
        "mission_pool": [
...
preset_wol_with_prophecy: 'CampaignPresetDict' = {
    "global": {
        "type": "column",
        "mission_pool": [
            MissionGroupNames.WOL_MISSIONS,
...
preset_prophecy: 'CampaignPresetDict' = {"layouts": {"Prophecy": preset_wol["layouts"].pop("Prophecy")}}
preset_prophecy["layouts"]["Prophecy"].pop("entry_rules")
preset_prophecy["layouts"]["Prophecy"]["type"] = "gauntlet"
preset_prophecy["layouts"]["Prophecy"]["display_name"] = ""
preset_prophecy["layouts"]["Prophecy"]["missions"].append({ "index": "entrances", "entry_rules": [] })

preset_hots: 'CampaignPresetDict' = {
    "global": {
        "type": "column",
        "mission_pool": [
            MissionGroupNames.HOTS_MISSIONS,
...
preset_lotv_prologue: 'CampaignPresetDict' = {
    "min_difficulty": "easy",
    "layouts": {
        "Prologue": {
            "display_name": "",
...
preset_lotv: 'CampaignPresetDict' = {
    "global": {
        "type": "column",
        "mission_pool": [
            MissionGroupNames.LOTV_MISSIONS,
...
preset_lotv_epilogue: 'CampaignPresetDict' = {
    "min_difficulty": "very hard",
    "layouts": {
        "Epilogue": {
            "display_name": "",
...
def _remove_key_rules(entry_rules: list['EntryRulePresetDict']) -> list['EntryRulePresetDict']:
    return [rule for rule in entry_rules if not ("items" in rule and "Key" in rule["items"])]


def _make_key_rules_progressive(entry_rules: list['EntryRulePresetDict'], track: int) -> list['EntryRulePresetDict']:
...
def static_preset(preset: 'CampaignPresetDict') -> Callable[[dict[str, Any]], 'CampaignPresetDict']:
...
def get_used_layout_names() -> dict[SC2Campaign, tuple[int, list[str]]]:
    campaign_to_preset: dict[SC2Campaign, 'CampaignPresetDict'] = {
