...
resource_efficiency_cost_reduction = {
    ...
    item_names.DARK_TEMPLAR:  (0, 50, 0),
...
item_descriptions = {
    ...
    item_names.DARK_TEMPLAR_SHROUD_OF_ADUN: "Increases Dark Templar maximum shields by +80.",
    item_names.DARK_TEMPLAR_BLINK: _ability_desc("Dark Templars", "Blink"),
    item_names.DARK_TEMPLAR_RESOURCE_EFFICIENCY: _get_resource_efficiency_desc(item_names.DARK_TEMPLAR),
    ...
    item_names.AVENGER_SHADOW_GUARD_TRAINING: "Increases Avengers maximum life by +80.",
    item_names.AVENGER_WAY_OF_RETRIBUTION: "Allows Avengers to charge at nearby enemy units with kills.\nAlso grants temporary attack speed.",
    ...
    item_names.ARTANIS_LIGHTNING_DASH: "Artanis dashes to a target location,\ndealing 50 damage to ground enemies in the area and stunning them for 1.25 seconds.",
    item_names.ARTANIS_PHASE_PRISM: "Artanis puts a unit in stasis for 5 seconds, pulling nearby enemy units toward that unit. Can be recast for Artanis to swap places with the unit in stasis and then pull enemies toward himself.",
    item_names.ARTANIS_VALOR_OF_THE_FIRSTBORN: "Artanis gains 20% attack speed and restores shields equal to 25% of the damage dealt by his attacks.",
    item_names.ARTANIS_VOLTAIC_SHOCK: "Artanis deals 45 damage to enemy units in the area, increased to 75 against air units. Air units hit are grounded for 5 seconds.",
    item_names.ARTANIS_ASTRAL_WIND: "Artanis restores 175 shields and 75 life to himself, and heals nearby friendly units for 75 shields and 25 life. Its cooldown is reduced by 6 seconds whenever Artanis attacks.",
    item_names.ARTANIS_SHIELD_OVERLOAD: "Artanis gains +200 maximum shields. When Artanis casts an ability, he restores shields equal to the ability's energy cost.",
    item_names.ARTANIS_RESURGENCE: "When Artanis takes lethal damage, he becomes invulnerable for 3 seconds,\nafter which he knocks back all nearby enemies and fully restores his life and shields.\n240-second cooldown.",
    item_names.ARTANIS_PSIONIC_ASSAULT: "Allows Artanis to attack air units. This weapon can be enabled or disabled in Artanis' passive menu.",
    item_names.ARTANIS_FORCE_OF_WILL: "Artanis gains +150 maximum life and +100% shield and life regeneration. When Artanis is at max health, his life regeneration converts into shield regeneration.",
    item_names.ARTANIS_TEMPERED_IN_TWILIGHT: "Artanis gains +4 attack damage and restores +1 energy each time he attacks.",
    item_names.ARTANIS_STRENGTH_IN_UNITY: "Artanis grants bonuses to nearby friendly units based on the Protoss factions of the units around him. Artanis gains double these bonuses and counts as the faction of his Weapon Aspect.",
    item_names.ARTANIS_SUPPRESSION_PULSE: "Artanis deals 20 damage to nearby enemies and reduces their attack damage by 100% for 4 seconds.",
    item_names.ARTANIS_EXTERMINATE: "Tal'darim Aspect Active.\nArtanis charges his target and begins attacking them, gaining +15 attack damage and 100% attack speed for 6 seconds.",
    item_names.ARTANIS_MALASHS_MALEVOLENCE: "Tal'darim Aspect Passive.\nArtanis' attacks deal an additional 7 damage to 4 enemy units near his target.",
    item_names.ARTANIS_CLEANSING_SMITE: "Purifier Aspect Active.\nArtanis deals 50 damage to nearby enemy units and an additional 50 damage over 5 seconds. The damage over time restores shields to Artanis equal to 75% of the damage dealt.",
    item_names.ARTANIS_CLOLARIONS_CONFIDENCE: "Purifier Aspect Passive.\nWhenever Artanis takes damage, he deals 25 damage to a nearby enemy. Can only occur once per second.",
    item_names.ARTANIS_SHADOW_SLICE: "Nerazim Aspect Active.\nArtanis quickly teleports behind an enemy and deals 175 damage to them before teleporting back. This ability's cooldown and cost are refunded by 50% if it kills the targeted enemy.",
    item_names.ARTANIS_RASZAGALS_RHYTHM: "Nerazim Aspect Passive.\nWhen Artanis uses an ability, his next attack deals 25 additional damage and restores 10 energy.",
    item_names.ARTANIS_BLADE_WALTZ: "Aiur Aspect Active.\nArtanis dashes forward, dealing 50 damage to all enemies he passes through and an additional 50 damage to enemies near the end of the dash.",
    item_names.ARTANIS_TASSADARS_TEACHINGS: "Aiur Aspect Passive.\nWhen Artanis uses an ability, he deals 10 damage to enemies in its area of effect. Charge empowers his next attack to deal AoE damage.",
