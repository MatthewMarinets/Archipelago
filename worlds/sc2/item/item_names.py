...
DOMINION_TROOPER_B2_HIGH_CAL_LMG                   = "B-2 Assault Modification (Dominion Trooper)"
...
FIREBAT_STIMPACK                                   = "Stimpack (Firebat)"
FIREBAT_MEDPACK                                    = "Medpack (Firebat)"
...
HELLION_JUMP_JETS                                  = "Jump Jets (Hellion/Hellbat)"
HELLION_OPTIMIZED_LOGISTICS                        = "Optimized Logistics (Hellion/Hellbat)"
HELLION_STIMPACK                                   = "Stimpack (Hellion/Hellbat)"
HELLION_MEDPACK                                    = "Medpack (Hellion/Hellbat)"
HELLION_SMART_SERVOS                               = "Smart Servos (Hellion)"
HELLION_THERMITE_FILAMENTS                         = "Thermite Filaments (Hellion/Hellbat)"
HELLION_TWIN_LINKED_FLAMETHROWER                   = "Twin-Linked Flamethrower (Hellion)"
HELLION_INFERNAL_PLATING                           = "Infernal Plating (Hellion/Hellbat)"
...
MARAUDER_STIMPACK                                  = "Stimpack (Marauder)"
MARAUDER_MEDPACK                                   = "Medpack (Marauder)"
...
MARINE_STIMPACK                                    = "Stimpack (Marine)"
MARINE_MEDPACK                                     = "Medpack (Marine)"
...
REAPER_STIMPACK                                    = "Stimpack (Reaper)"
REAPER_MEDPACK                                     = "Medpack (Reaper)"
...
WIDOW_MINE_LINGERING_CONCEALMENT                   = "Lingering Concealment (Widow Mine)"
...
RAVAGER_DISINTEGRATING_ACID                       = "Disintegrating Acid (Ravager)"
RAVAGER_AERIAL_CORROSIVE_BILE                     = "Aerial Corrosive Bile (Ravager)"
RAVAGER_BURROWED_BOMBARDMENT                      = "Burrowed Bombardment (Ravager)"
RAVAGER_BONE_PLATING                              = "Bone Plating (Ravager)"
RAVAGER_WRITHING_ABOMINATION                      = "Writhing Abomination (Ravager)"
...
CORRUPTOR_SPOREFALL                               = "Sporefall (Corruptor)"
...
DRAGOON_RESOURCE_EFFICIENCY                             = "Resource Efficiency (Dragoon)"
...
PHOENIX_IONIC_WAVELENGTH_FLUX                           = "Ionic Wavelength Flux (Phoenix)"
PHOENIX_ANION_PULSE_CRYSTALS                            = "Anion Pulse-Crystals (Phoenix)"
PHOENIX_SHIELD_CAPACITY                                 = "Shield Capacity (Phoenix)"
PHOENIX_LEVITATION_BOOSTER                              = "Levitation Booster (Phoenix)"
PHOENIX_GRAVIMETRIC_DISCHARGE                           = "Gravimetric Discharge (Phoenix)"
PHOENIX_ACCELERATED_WARP                                = "Accelerated Warp (Phoenix)"
MIRAGE_AFTERIMAGE                                       = "Afterimage (Mirage)"
MIRAGE_ETERNAL_DUTY                                     = "Eternal Duty (Mirage)"
MIRAGE_OBSERVER_MODULE                                  = "Observer Module (Mirage)"
MIRAGE_PHASE_ALIGNMENT                                  = "Phase Alignment (Mirage)"
SKIRMISHER_BLOODSHARD_COATING                           = "Bloodshard Coating (Skirmisher)"
SKIRMISHER_ESSENCE_DRAIN                                = "Essence Drain (Skirmisher)"
SKIRMISHER_TERRAZINE_INJECTORS                          = "Terrazine Injectors (Skirmisher)"
SKIRMISHER_ULTIMATE_SACRIFICE                           = "Ultimate Sacrifice (Skirmisher)"
SKIRMISHER_RESOURCE_EFFICIENCY                          = "Resource Efficiency (Skirmisher)"
...
IMMORTAL_ADVANCED_TARGETING                             = "Advanced Targeting (Immortal)"
IMMORTAL_COUNTERMEASURES                                = "Countermeasures (Immortal)"
IMMORTAL_WARP_RELOCATE                                  = "Warp Relocate (Immortal)"
IMMORTAL_ETERNAL_DUTY                                   = "Eternal Duty (Immortal)"
IMMORTAL_NANO_REASSEMBLY                                = "Nano Reassembly (Immortal)"
ANNIHILATOR_SINGULARITY_CHARGE                          = "Singularity Charge (Annihilator)"
ANNIHILATOR_ADVANCED_TARGETING                          = "Advanced Targeting (Annihilator)"
ANNIHILATOR_DISRUPTOR_DISPERSION                        = "Disruptor Dispersion (Annihilator)"
ANNIHILATOR_SHADOW_PATH                                 = "Shadow Path (Annihilator)"
ANNIHILATOR_RESOURCE_EFFICIENCY                         = "Resource Efficiency (Annihilator)"
VANGUARD_AGONY_LAUNCHERS                                = "Agony Launchers (Vanguard)"
VANGUARD_MATTER_DISPERSION                              = "Matter Dispersion (Vanguard)"
VANGUARD_FLARE                                          = "Flare (Vanguard)"
VANGUARD_ACCELERATED_WARP                               = "Accelerated Warp (Vanguard)"
VANGUARD_BLOODSHARD_COATING                             = "Bloodshard Coating (Vanguard)"
...
DARK_TEMPLAR_SHROUD_OF_ADUN                             = "Shroud of Adun (Dark Templar)"
DARK_TEMPLAR_BLINK                                      = "Blink (Dark Templar)"
DARK_TEMPLAR_RESOURCE_EFFICIENCY                        = "Resource Efficiency (Dark Templar)"
DARK_TEMPLAR_DARK_ARCHON_MELD                           = "Dark Archon Meld (Dark Templar)"
DARK_TEMPLAR_ARCHON_MERGE                               = "Archon Merge (Dark Templar)"
AVENGER_SHADOW_GUARD_TRAINING                           = "Shadow Guard Training (Avenger)"
AVENGER_WAY_OF_RETRIBUTION                              = "Way of Retribution (Avenger)"
AVENGER_STRATEGIC_RETREAT                               = "Strategic Retreat (Avenger)"
AVENGER_ACCELERATED_WARP                                = "Accelerated Warp (Avenger)"
BLOOD_HUNTER_FROZEN_IN_AGONY                            = "Frozen in Agony (Blood Hunter)"
BLOOD_HUNTER_ESSENCE_DRAIN                              = "Essence Drain (Blood Hunter)"
BLOOD_HUNTER_ALARAKS_CALL                               = "Alarak's Call (Blood Hunter)"
